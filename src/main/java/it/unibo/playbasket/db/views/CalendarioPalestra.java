...
public class CalendarioPalestra {
    ...
    public CalendarioPalestra(String nome_squadra1, String nome_squadra2, String nome_palestra, String indirizzo, String data_ora) {
