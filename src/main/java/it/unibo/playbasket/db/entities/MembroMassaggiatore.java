...
public class MembroMassaggiatore {
    ...
    public MembroMassaggiatore(String tesseraFip, String idCampionato, String nomeSquadra, int anno, char nomeGirone, int stipendio) {
