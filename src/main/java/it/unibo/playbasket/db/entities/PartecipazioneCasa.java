...
public class PartecipazioneCasa {
    ...
    public PartecipazioneCasa(String codicePalestra, Date daraOra, String idCampionato, int anno, char nomeGirone, String nomeSquadra, int puntiFatti) {
