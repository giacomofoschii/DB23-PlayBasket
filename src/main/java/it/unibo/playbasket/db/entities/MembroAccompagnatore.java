...
public class MembroAccompagnatore {
    ...
    public MembroAccompagnatore(String tesseraFip, String idCampionato, String nomeSquadra, int anno, char nomeGirone, int stipendio) {
